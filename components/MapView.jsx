...
// ---------------------------------------------------------------------------
function buildLeafletHtml(region, markers, polylines, polygons, circles, options) {
  ...
  return (
    <View style={style} className={className}>
      <RNMapView
        ...
        region={region}
        mapType={NATIVE_MAP_TYPE[mapType]}
        ...
        onPress={
          onPress ? (e) => onPress({ coordinate: e.nativeEvent.coordinate }) : undefined
        }
        onLongPress={
          onLongPress ? (e) => onLongPress({ coordinate: e.nativeEvent.coordinate }) : undefined
        }
      >
        {markers.map((marker, index) => (
          <Marker
            ...
            onDragEnd={
              marker.onDragEnd ? (e) => marker.onDragEnd(e.nativeEvent.coordinate) : undefined
            }
