            ...
            <View className="items-center gap-3">
              ...
              >
                ...
                <Text
                  ...
                  style={{ fontFamily: webFont('Unbounded') } as never}
                >
                  L
                </Text>
              </View>
              <Text
                ...
                style={{ fontFamily: webFont('Unbounded'), letterSpacing: -0.5 } as never}
              >
                LinkUp
              </Text>
              ...
              {(['signin', 'signup'] as const).map((m) => {
                ...
                return (
                  <Pressable
                    ...
                    style={
                      active
                        ? ({ backgroundColor: 'hsl(320 95% 60% / 0.18)' } as never)
                        : undefined
                    }
                  >
                    <Text
...
function webFont(name: string): string | undefined {
